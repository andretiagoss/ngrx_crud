...
export class CustomerEffect {
  ...
  @Effect()
  //create an observable to listen to the action of type LoadCustomer to load data from the API and 
  //throw a new action of type LoadCustomerSuccess in case of success or LoadCustomerFail in case of fail
